...
public class ControlApplication {
    ...
    public void setPhoneBookService(IPhoneBookService phoneBookService) { this.phoneBookService=phoneBookService; }
    ...
    public void printList() { this.printList( this.phoneBookService.getAllList() ); }
    ...
    private IPhoneBook getFindIdConsole(Scanner input, String title) {
        ...
        IPhoneBook result = (IPhoneBook) this.phoneBookService.findById(l);
        return result;
    }
